...
/**
 * Experiment mirror of /sign-in. Mirrors the prod auth flow (magic link +
 * Discord/Google OAuth) verbatim, but redirects post-auth to
 * /experiments/home so the user stays inside the preview sandbox.
 */
function SignInForm() {
  ...
  const redirectTo = () =>
    `${window.location.origin}/auth/callback?next=/experiments/home`;
...
export default function ExperimentSignInPage() {
  return (
