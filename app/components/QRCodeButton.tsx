  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-md bg-black border border-transparent px-3 py-1.5 text-xs font-semibold text-white disabled:opacity-50 transition-opacity hover:opacity-80"
      >
        {loading ? (
          /* Spinner */
          <svg
