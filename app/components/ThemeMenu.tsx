  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      <button
        ...
        className="flex flex-col justify-center items-center gap-[4px] w-8 h-8 rounded-md hover:bg-surface-2 transition-colors"
      >
        <span className="block w-5 h-[2px] rounded-full bg-text-secondary" />
        <span className="block w-5 h-[2px] rounded-full bg-text-secondary" />
        <span className="block w-5 h-[2px] rounded-full bg-text-secondary" />
      </button>
