...
Some Pokémon (ex, V, VMAX, and similar special cards) give up **two prize cards** when knocked out, not one. We'll cover what that means for strategy in the next lesson.
