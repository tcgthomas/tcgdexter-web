...
That's the floor. The rest of Trainer School (coming soon) goes deeper — building decks from scratch, beginner strategy, and getting plugged into the community. For now, go play some games and log them. That's the fastest way to improve.
